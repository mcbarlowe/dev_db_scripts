...
#Create Table to store raw pbp
    ...
    cursor.execute("""
               CREATE TABLE nhl_tables.team_allsits(
               season integer,
               game_id integer,
               date date,
               team text,
               ...
               """)
    cursor.execute("""
               CREATE TABLE nhl_tables.team_5v5(
               season integer,
               game_id integer,
               date date,
               team text,
               ...
               """)
    cursor.execute("""
               CREATE TABLE nhl_tables.team_4v4(
               season integer,
               game_id integer,
               date date,
               team text,
               ...
               """)
    cursor.execute("""
               CREATE TABLE nhl_tables.team_3v3(
               season integer,
               game_id integer,
               date date,
               team text,
               ...
               """)
    cursor.execute("""
               CREATE TABLE nhl_tables.team_5v4(
               season integer,
               game_id integer,
               date date,
               team text,
               ...
               """)
    cursor.execute("""
               CREATE TABLE nhl_tables.team_4v5(
               season integer,
               game_id integer,
               date date,
               team text,
               ...
               """)
    cursor.execute("""
               CREATE TABLE nhl_tables.team_4v3(
               season integer,
               game_id integer,
               date date,
               team text,
    ...
    cursor.execute("""
               CREATE TABLE nhl_tables.team_3v4(
               season integer,
               game_id integer,
               date date,
               team text,
    ...
    cursor.execute("""
               CREATE TABLE nhl_tables.team_5v3(
               season integer,
               game_id integer,
               date date,
               team text,
    ...
    cursor.execute("""
               ...
               """)
    cursor.execute("""
               CREATE TABLE nhl_tables.goalie_3v3(
               season integer,
               game_id integer,
               date date,
               team text,
               ...
               """)
    cursor.execute("""
               CREATE TABLE nhl_tables.goalie_4v4(
               season integer,
               game_id integer,
               date date,
               team text,
